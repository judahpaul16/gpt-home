...
alias gh-start="docker exec -it gpt-home supervisorctl start gpt-home"
alias gh-restart="docker exec -it gpt-home supervisorctl restart gpt-home"
alias gh-stop="docker exec -it gpt-home supervisorctl stop gpt-home"
alias gh-status="docker exec -it gpt-home supervisorctl status gpt-home"
alias gh-log="docker exec -it gpt-home tail -n 100 -f /path/to/your/application/logs/events.log"

alias gw-start="docker exec -it gpt-home supervisorctl start gpt-web"
alias gw-restart="docker exec -it gpt-home supervisorctl restart gpt-web && sudo systemctl restart nginx"
alias gw-stop="docker exec -it gpt-home supervisorctl stop gpt-web"
alias gw-status="docker exec -it gpt-home supervisorctl status gpt-web"
alias gw-log="tail -n 100 -f /var/log/nginx/access.log"
alias gw-error="tail -n 100 -f /var/log/nginx/error.log"
