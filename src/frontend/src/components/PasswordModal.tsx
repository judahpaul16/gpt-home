...
const PasswordModal: React.FC<PasswordModalProps> = ({ unlockApp, darkMode, toggleDarkMode }) => {
          ...
          axios.post('/setHashedPassword', { hashedPassword: hashedInput })
            .then(response => {
              if (response.data.success) {
                ...
                setError(`Error saving password: ${response.data.error}`);
              }
            })
            .catch(error => {
      ...
      >
        <div className="glass-card p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold gradient-text">GPT Home</h1>
            <p className="text-slate-500 dark:text-slate-400">
              {hashedPassword ? 'Enter your password to continue' : 'Create a password to get started'}
            </p>
          </div>
