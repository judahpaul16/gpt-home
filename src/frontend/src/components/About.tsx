                    ...
                    >
                        <div className="bg-gradient-to-br from-primary-500 via-accent-violet to-accent-cyan p-8 relative">
                            ...
                            <div className="relative text-center">
                                ...
                                <p className="text-white/80">
                                    Smart Assistant for Raspberry Pi
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-6 space-y-4">
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                                ChatGPT at home! A better alternative to
                                commercial smart home assistants, built on the
                                Raspberry Pi using LiteLLM and LangGraph.
                            </p>
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <span className="flex-1 text-slate-700 dark:text-slate-300 group-hover:text-primary-500 transition-colors">
                                    Source Code
                                </span>
                    ...
                    >
                        ...
                        <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-3">
                            ...
                            are free to use, modify, and distribute this
