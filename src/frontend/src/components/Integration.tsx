...
const Integration: React.FC<IntegrationProps> = ({ name, usage, status, requiredFields, toggleStatus, setShowOverlay }) => {
  ...
  const apiRefs: { [key: string]: string[] } = {
    ...
    CalDAV: ['https://en.wikipedia.org/wiki/CalDAV', 'https://caldav.readthedocs.io/en/latest/', 'https://radicale.org/v3.html', 'https://github.com/judahpaul16/nextcloud-docker'],
  };
